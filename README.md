# ![Site Brand](assets/img/logo_black.png) Portfolio Website: [ellenstafford.com](https://ellenst264.github.io/ellenstafford/)

[View live project here](https://ellenst264.github.io/ellenstafford/)

This website is an online portfolio, or resume, designed to showcase my skills and qualifications. It is also a great and intuitive way to learn more about me.
...
The primary aim of this website is to establish an online presence for myself and to impress potential recruiters who may hire me. Unlike a traditional CV or resume, this online portfolio allows my skills to speak for themselves, with the website itself acting as an exemplar of my current skill set. By using HTML, CSS and a little Javascript, this website gives users an easy and aesthetically pleasing interface for them to discover who I am. 

 ### Project Goals 
 
The goal of this site is to portray myself in the best light by advertising my skills and assets to potential employers/recruiters who may wish to hire me. The site also functions as a mechanism to showcase my skills and does this by offering a unique and engaging user interface. The goal is to encourage traffic and increase my prospects in the career world. The additional goal is to inspire users and ensure that the site meets their own user goals to a high standard.
 
 ### Target Audience 

The primary target audience for this website is recruiters and employers looking for someone to fulfil a role in software or web development. But the site is also open to audiences who want to know more about me. 
...
-   #### First Time Visitor Goals     
    ...
    - As a first-time visitor, I want to understand the primary purpose of the site immediately.
    - I want to easily navigate through the site's content. 
    - Similarly, I do not want to decode the site's features to use them - no features should be hard to find or hard to perceive as a feature. 
    - I want to easily find information about the potential candidate I may hire. 
    - As a first-time visitor, I also want to see immediately the potential of the candidate which means the site itself needs to meet a desired professional quality.
    ...
    - Most significantly, as a first-time visitor, I want to *like* the site so I will revisit it again. 
    
-  #### Returning Visitor Goals    

    - As a returning visitor, I want to see the projects the candidate may have worked on. 
    - I want to see their qualifications, relevant work experience and what skills they have.
    - I want to contact the candidate at any point throughout my navigation of the site so they can answer any questions I may have.
...
I have imported [Poppins](https://fonts.google.com/specimen/Poppins?query=poppin) and [Josefin Sans](https://fonts.google.com/specimen/Josefin+Sans?query=jose) from [Google Fonts](https://fonts.google.com/), which I have consistently used throughout the site. Both fonts have Sans Serif as a fallback font in case the two fonts fail to import. 

- I used Poppins for most of the site's written text. It is a clean, readable font, making it both visually pleasing and appropriate.

  - As according to the image above regarding the psychology behind type choices, Poppins can be seen as a combination of Sans Serif and Modern fonts. Therefore, the connotations and emotions associated with the font include: clean, modern and reliable.

- I used Josefin Sans for most of the site's headers (h1-h6 elements), and the navbar, navbar brand and the button on the homepage and contact form. It is bolder than the Poppins font, which thus allows for a good visual contrast between titles and content. It also helps to distinguish particular sections from the entire body of the site. 

  - We can Josefin Sans see as a hybrid between Serif, Sans Serif and Modern fonts. According to the psychology behind typography, Josefin Sans can evoke a combination of positive associations and emotions, such as respectability, reliability, stability and strength.
...
The four dominant colours I have used on the site are cyan blue, white, a light pink and violet. 

- White is a clean colour and is often used to create the illusion of space. In relation to web design, it visually declutters the site and reduces cognitive overload. We associate the colour with simplicity and honesty.
  
  - Dark UI's can be a risky choice for websites with text-heavy and/or data-heavy content. A portfolio website, by nature, is going to be fairly content-heavy. Therefore, I wanted to promote a light UI appropriate for the site's content. 
  
  - A white/light background with darker text on top is easier to read, making the colour choice even more suitable.

- The colour blue is symbolic of trust and reliability, which is one of the intended responses I wanted from users visiting the site. As the site ultimately functions as an online representation of myself, this reaction is exactly what I want from users.
...
- I chose a light pink as a substitute of the colour red. While red can incite positive emotional responses, such as passion and energy, it can also trigger undesirable emotional responses, such as danger or urgency, which are not appropriate reactions for my site. I considered pink to be a happy compromise, as it has that hint of red to suggest passion and energy, while being gentle enough as to not incite undesirable reactions. 
  ...
  - The colour pink can also be an immediate sign to my gender.

- Compared to the other colours, I have applied violet sparingly used for buttons (i.e. the 'read more' buttons and project links) and title underlining with the hr element. The rule of three comes into play here - having *too many* colours shown *too often* might cause cognitive overload for the user and disrupt the site's consistency.
  ...
  - Violet, like purple, is associated with ambition, which is an appropriate portrayal of myself and thus appropriate for the website. 
...
- #FFF White:
  ...
  - 'Experience' page card's background colour
  - Social media links
...
I created a site brand using [Tailor Brands Studio](https://www.tailorbrands.com/) to make my site both unique and professional. I used visual imagery rather than just text to make the brand more recognisable and easier to remember - we are often visual by nature, so I believe this effect would work well. The design choice was not arbitrary either, as it is a subtle indication to my personality and interests. I perceive the raven as symbolic of wisdom and intrigue, but they can also have deeply spiritual connotations. 

If I wish to create more projects, such as a blog, for example, I can use this brand to show that it is of my creation -  like a signature or trademark.

To correlate with the branding, I have implemented a raven in the background image for the navbar's fullscreen-overlay menu when on mobile devices to maintain a consistent theme throughout.


### Design Layout

I have split each page into half - depending on the screen size of your device this will either be a horizontal split for desktops and tablets, or a vertical split for mobile devices. For this I took a lot of inspiration from [this website](http://melaniedaveid.com/), but I tweaked it to make it my own. I felt the aesthetic was analogous to a book which reflected my past devotion to literature and as the primary purpose of the website is for users to *read* and learn more about me, it thus correlated well to the site's theme and purpose.

The layout provides a distinct method of distinguishing titles from their content. I have referred to this in commit messages and syntax as 'page chapters' and 'page content'.

However, the layout could have benefitted from some improvement. I know that I may risk showing *too much* content for a single page website which I have discussed in more detail [here](#areas-of-improvement)
...
I prepared all my wireframes in [Balsamiq](https://balsamiq.com/). Balsamiq allowed me to visualise the site's aesthetic before creating any of the code and helped with the construction of the surface plane. 
...
The only difference between tablet and desktop is the collapsible navbar with the hamburger icon. However, as this alteration is represented in the mobile wireframe, I deemed it unnecessary to add a tablet wireframe *just* to convey this feature alone.
...
- Fixed navigation bar 
  ...
  - Enhances user experience - particularly on mobile devices, as a user is unlikely to want to scroll to the top of the page; a fixed navbar addresses this annoyance.
...
- Dropdown-menu 
  ...
  - It declutters the navbar to maintain a clean aesthetic.
...
- Fullscreen overlay menu for mobile devices 
  ...
  - This makes the navbar easier to use on mobile devices, particularly smaller ones.
...
- Background hero-image 
  - Adds visual depth.
  - Subtly fulfils a site goal by showing, rather than telling, who I am (the picture is of myself when travelling in China). 

- Bootstrap jumbotron
  - Outlines the purpose of the site.
  - The jumbotron introduces the site to the user, with 'Hi, I'm Ellen', which is a quick indication to what the site is - an online portfolio. 
...
- Progress bars
  - Provides an intuitive, highly visual way for users to quickly and easily see my skill set and qualifications.
...
- Hover effect for Personal Strengths
  ...
  - Employers expect 100% from these qualities, so if the progress bars were not 100% it would have made a poor impression of myself. But setting all the progress bars at 100% could have looked dishonest. Removing them was the best solution to this problem. 

#### Experience Page

- Experience Timeline
  - Three different timelines for education, work experience and achievements - ordered from most significant to least significant. 
...
- Project images 
  - Used Bootstrap's card-deck class for responsiveness.
  - I represent each project with an image rather than text - the visual emphasis preserves a positive user experience.
  - The project image is a mockup image of the project site, i.e. the homepage of Love Running on a mobile device, or an image which represents what exactly the project is, such as a picture of King Lear for my dissertation.
...
- Overlay menu for desktop devices
  - When hovering over the image on desktop devices, an overlay menu will activate.
...
- Project link icons
  - Under each project image is a link and GitHub icon. 
...
- Mobile responsiveness
  ...
  - To ensure the user experience is not negatively affected text will replace the overlay menu, which is activated on mobile devices.
...
- Image Carousel above the footer 
  - This is an intuitive, fun way for users to learn more about me as a person - offering more than my qualifications, experience and skill set.
...
- Contact Form
  - Reduces the steps a user will have to take to contact me by giving them the option to write a message within the site and send it to me directly.
  ...
  - Users would expect a method of contact here, thus the contact form meets user expectations.
  - Provides users a distinct form of contact that varies from just providing social media links.
  - The contact form is more personal than mere links, which encourages users to make contact, and in doing so fulfils the site's major purpose.
...
- CV Download
  ...
  - On mobile devices, the text 'Download my CV!' will be displayed underneath the icon in place of the hover tooltip, as hover effects can be problematic on mobile devices and touch screens.


### Features left to Implement 

- A blog page.
- Update social media to direct to my social media accounts.
...
- Add functionality to the contact form with PHP script.
...
When sharing the project with friends and family members, they provided me with useful feedback on how the project can improve. The following list is a selection of that feedback, which includes a list of features and/or changes that could be implemented into the project to make it better:
...
- Remove the **progress bars** from the **Personal Strengths** subheading in the **Skills** page.
  - This alteration was made after feedback - I **removed** the progress bars from the Personal Strengths section, with text added in its place.

- Add an email address *and* phone number that is **text based** rather than just an icon.
  - The same user recommended that a fixed footer may be beneficial, although this would take up a lot of real estate and might compromise good UX design. 
...
- To make the site's navigation more clear and user friendly, the site could have benefitted from having separate pages on the site. 
  ...
  - If I was to do the site again, or make big alterations to the site, I would add the Experience page as a **separate page** to further enhance the UX design. 
    - Nevertheless, the Scroll to Top arrow button at the bottom of the screen helps promote a clear and user friendly navigation and ensures the site's UX is not wholly compromised. 

- A big improvement that can be made to the site is its level of performance. 
  - Bootstrap's CDN had a major impact on the site's performance, so if I were to do it again, I would limit the amount of Bootstrap that I would use. Meaning that I would only load the Bootstrap that was essential (like the grid system, for example) and add more of my own custom CSS to help reduce render blocking resources. This was mentioned in more detail [here](testing.md#performance-issues)
  - Implementing separate pages could have helped with the site's performance and is something I shall keep in mind for future improvements and also future projects. 

-----

## Accessibility 

- I have given all image tags meaningful alt attributes to conform to accessibility guidelines. 
...
- Originally, the profile image in the About Me page and the project images in the Projects page were loaded as background images via CSS.
  ...
  - I changed these images to HTML image tags by executing the following steps:
  ...
  - Project images:
    ...
    5. Assigned the Bootstrap class `text-center` to the div
...
- [Tailor Brands Studio](https://www.tailorbrands.com/)
  - Tailor Brands Studio is a web-application that allows you to create free brands and logos. It was used to create the logo which is displayed in the navbar. 

- [MockupBro: Free Online Product Mockup Generator](https://mockupbro.com/)
  - MockupBro is a web-application that allows you to create free mockup images. Mockups allow you to demonstrate what a product, or in this instance, a website will look like. I used some of their mockup images in the Projects section of my website. 
...
- [PicResize - Crop, Resize, Edit images online](https://picresize.com/)
  - PicResize is a web-application that allows you to resize images and alter their width/height and pixel size. I used PicResize to make the carousel images a similar height and width to prevent the page jumping with each transition.
...
- [Uptrends](https://www.uptrends.com/tools/website-speed-test)
  - Uptrends is an online web tool used to monitor a website's uptime and optimise performance. It was used to analyse the speed of my website.
...
- [Ezgif.com](https://ezgif.com/webp-to-png)
  - Ezgif is an online gif editor and image editor. It was used to convert webP back to PNG format and resize gif images.
...
The website was developed by using [Visual Studio Code](https://code.visualstudio.com/) and [Git](https://git-scm.com/) to push to GitHub, which hosts the repository. I deployed teh website to GitHub Pages using the following steps:
...
- [Bootstrap 4](https://getbootstrap.com/) has been used regularly, it has been implemented most effectively in the following features:
...
- To correctly nest columns of the Bootstrap grid, I followed the format of this [StackOverflow post](https://stackoverflow.com/questions/24659471/nested-rows-with-bootstrap-grid-system)  
...
- To help me vertically centre the jumbotron on the homepage, I looked to [this css guide from CSS Tricks](https://css-tricks.com/perfect-full-page-background-image/)
...
- To centre the project overlay paragraphs when on mobile screens I used a code snippet from this [StackOverflow post](https://stackoverflow.com/questions/5581034/is-there-are-way-to-make-a-child-divs-width-wider-than-the-parent-div-using-css)
...
- The Javascript code for the navbar fullscreen overlay menu was edited and fixed by [Scott Kip](https://github.com/ShavingSeagull) from Code Institute.
...
The following websites were used inspired the design on my website and/or inspired my to include certain features:
...
- I want thank to Johann and Scott from Code Institute for their assistance with this project.
